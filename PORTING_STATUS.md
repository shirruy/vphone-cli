...
| 4 | Firmware/restore/archive parity | IN_PROGRESS | Prove Windows-native parity for firmware parsing, restore/archive primitives, and explicitly isolate macOS-only APFS/cryptex/sealing operations behind replacement interfaces. |
