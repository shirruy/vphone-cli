...
| 4 | Firmware/restore/archive parity | IN_PROGRESS | Phase 4A PASS. Phase 4B PASS on physical Windows and GitHub CI at commit `2ef9235e4f3aae6a710482a6fdebc61213fda56c`: 383 compile units, 0 UNKNOWN, 15/15 Release-mode tests PASS, GNU tar write/read supported with byte-parity roundtrip, archive CLI capability gate PASS, compression and Darwin metadata explicitly unsupported. Phase 4C1 PASS on physical Windows and GitHub CI at commit `89e4235cfe8096dd876b6070f6f3e2e69683d639`: 386 compile units, 0 UNKNOWN, 17/17 Release-mode tests PASS, bundle manifest/path-safety and Windows hardlink identity verified. Phase 4C2 now targets gzip/xz/zstd transport compression parity. |
