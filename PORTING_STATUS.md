...
| 4 | Firmware/restore/archive parity | IN_PROGRESS | Phase 4A PASS on physical Windows and CI at commit `ce78cd1c6fe61d02dee4fd0d3696e55b168b905a`: 381 compile units, 0 UNKNOWN, 13/13 Release-mode tests PASS, FTAB/MBN supported, AEA/APFS host operations explicitly unsupported. Phase 4B now targets archive and broader restore parity. |
